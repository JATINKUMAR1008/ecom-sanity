...
// Source: ./src/sanity/lib/order/getOrder.ts
// Variable: ORDER_QUERY
// Query: *[_type=="order" && clerkCustomerId==$userId] | order(orderDate desc){            ...,            products[]{                ...,                product->            }        }
...
// Source: ./src/sanity/lib/sales/getSaleByCoupon.ts
// Variable: ACTIVE_SALE_QUERY
// Query: *[_type == "sales" && isActive == true && couponCode == $coupon] | order(validFrom desc)[0]
...
declare module "@sanity/client" {
  interface SanityQueries {
    ...
    "\n        *[_type == \"sales\" && isActive == true && couponCode == $coupon] | order(validFrom desc)[0]": ACTIVE_SALE_QUERYResult;
  }
}
